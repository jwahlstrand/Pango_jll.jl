...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Pango_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("36c8627f-9965-5494-a995-c6b170f724f3"))
...
if best_platform === nothing
    @debug("Unable to load Pango; unsupported platform $(triplet(platform_key_abi()))")
else
